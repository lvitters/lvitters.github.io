(function () {
	 ...
	 */
	function mountUntiledPreviewSketch(containerId) {
		...
		const sketch = function (p) {
			...
			var tileSize;
			var gap;
			var tilesPerRow = 14; // preview uses 14 tiles per row
	...
	window.mountUntiledPreviewSketch = mountUntiledPreviewSketch;
})();
